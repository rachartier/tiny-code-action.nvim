...
function M.create_previewer(opts, bufnr, backend, preview_action_callback)
	-- We're using Telescope
	if opts.picker == "telescope" and has_telescope then
	...
	-- For Snacks or any other picker, we'll just return the backend data
	-- The actual preview rendering is handled by the picker
	return nil
end

-- Use the terminal utility's helper function to check if content looks like a diff
